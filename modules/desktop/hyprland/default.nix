          ...
          wayland.windowManager.hyprland = {
            ...
            settings = {
              ...
              windowrule = [
                ...
                "opacity 1.00 1.00,class:^(VSCodium)$"
                "opacity 0.80 0.80,class:^(codium-url-handler)$"
                "opacity 1.00 1.00,class:^(code)$"
                "opacity 1.00 1.00,class:^(code-url-handler)$"
            ...
            extraConfig = ''
              ...
              # Схема расположения мониторов 1080p-HDR слева, 1080p-HDR центр и 1080p справа.
              #monitor=desc:BNQ BenQ EW277HDR 99J01861SL0,preferred,-1920x0,1  #Настройки монитора слева
              monitor=desc:Chimei Innolux Corporation 0x173,preferred,0x0,1  #Настройки центрального монитора
              monitor=desc:Philips Consumer Electronics Company 227 E4L,preferred,1920x0,1,transform,1 # Настройки правого монитора

              # Закрепление workspaces на мои мониторы (посик мониторов с : hyprctl monitors) desc это описание 
              workspace=1,monitor:eDP-1,default:true
              workspace=2,monitor:eDP-1
              workspace=3,monitor:eDP-1
              workspace=4,monitor:eDP-1
              workspace=5,monitor:VGA-1,default:true
